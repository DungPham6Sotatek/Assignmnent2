package automation.common.utils;
...
public class PropertiesFile {
    ...
    private static String customPath = "src/test/configs.properties";

    public static void setPropertiesFile(String customPath) {
        properties = new Properties();
        try {
            //Khởi tạo giá trị cho đối tượng của class FileInputStream
        	File file = new File(projectPath + customPath);
        	if(!file.exists()) {
        		file.getParentFile().mkdirs(); 
        		file.createNewFile();
        		System.out.println("File không tồn tại, đã tạo file mới tại: " + customPath);
        	}
            ...
            fileIn = new FileInputStream(projectPath + customPath);
    ...
    public static void setPropValue(String customPath, String KeyProp, String Value) {
        try {
            //Khởi tạo giá trị cho đối tượng của class FileOutputStream
            fileOut = new FileOutputStream(projectPath + customPath);
